...
class MasterDataDepartmentApiTest {
    ...
    void searchesDepartmentsWithPagingAndFilters() throws Exception {
        ...
        mockMvc.perform(get("/api/master-data/departments/manage")
                        .param("keyword", "心")
    ...
    void createsDepartmentAndReturnsSavedRow() throws Exception {
        mockMvc.perform(post("/api/master-data/departments/manage")
    ...
    void updatesDepartmentAndReturnsSavedRow() throws Exception {
        ...
        mockMvc.perform(put("/api/master-data/departments/manage/{id}", id)
                        .contentType("application/json")
                        .content("""
                                {
                                  "code": "DERM2",
    ...
    void changesDepartmentActiveState() throws Exception {
        ...
        mockMvc.perform(patch("/api/master-data/departments/manage/{id}/active", id)
                        .contentType("application/json")
    ...
    void returnsNotFoundWhenUpdatingMissingDepartment() throws Exception {
        mockMvc.perform(put("/api/master-data/departments/manage/{id}", 999L)
                        .contentType("application/json")
                        .content("""
                                {
                                  "code": "MISS",
